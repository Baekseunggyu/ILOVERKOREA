								...
								<form method="post" enctype="multipart/form-data "
									...
									<div class="form-group">
										<label>관광지명:</label> <input type="text" name="tourName"
											class="forms-sample" id="tourName">
									</div>
									<div class="form-group">
										<label>위도:</label> <input type="text" name="tourMapx"
											class="forms-sample" id="tourMapx">
									</div>
									<div class="form-group">
										<label>경도:</label> <input type="text" name="tourMapy"
											class="forms-sample" id="tourMapy">
									</div>
									...
									<div class="form-group">
										<label>도시명:</label> <select name="cityId">
									...
									<div>
										...
										<a type="button" href="list"
											...
											class="fa fa-warning btn-icon-prepend"></i>목록으로
										</a>
									</div>
								</form>
							</div>
