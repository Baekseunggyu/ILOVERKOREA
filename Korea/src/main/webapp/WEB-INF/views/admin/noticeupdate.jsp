							...
							<div class="card mt-5">
								<div class="card-body">
									...
									<form name="form" method="post" class="forms-sample">
										...
										<div class="form-group">
											<label>제목:</label> <input name="nSubject" type="text"
												value="${item.nSubject}" class="form-control">
										</div>
										<div class="form-group">
											<label>내용:</label>
										...
										<div class="form-group">
											<label>작성자</label> <input name="nWriter" type="text"
												value="${item.nWriter}" class="form-control" readonly>
										</div>
										...
										<div>
											<button class="btn btn-outline-success btn-icon-text mx-2"
												style="float: right;">
												<i class="fa fa-warning btn-icon-prepend"
													onclick="location.href='/adminlist'">취소</i>
											</button>
