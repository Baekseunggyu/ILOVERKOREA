	...
	<div id="wrapper" class="toggled">
		...
		<div id="page-content-wrapper">
			<div class="container-fluid">
				<div
					style="height: 100px; background-color: #ccccc; text-align: center; margin: 1px solid #ccc">
					<h3>관리자페이지 입니다</h3>
				</div>
				<div style="text-align: center;">
					<div class="d-flex justify-content-center">
						<div class="mb-4 mx-5">
							<div class="card h-100">
								<img src="/resources/image/icon/공지사항.png" class="card-img-top "
									onclick="location.href='/admin/noticelist'">
								<div class="card-body">
						...
						<div class="mb-4 mx-5">
							<div class="card h-100">
								<img src="/resources/image/icon/멤버.png" class="card-img-top"
						...
						<div class="mb-4 mx-5">
							<div class="card h-100">
								<img src="/resources/image/icon/관광지.png" class="card-img-top"
									onclick="location.href='/admin/tourlist'">
								<div class="card-body">
					...
					<div class="d-flex justify-content-center">
						<div class="mb-4 mx-5">
							<div class="card h-100">
								<img src="/resources/image/icon/지역.png" class="card-img-top"
									onclick="location.href='/area/list'">
								<div class="card-body">
						...
						<div class="mb-4 mx-5">
							<div class="card h-100">
								<img src="/resources/image/icon/도시.png" class="card-img-top"
									onclick="location.href='/city/list'">
								<div class="card-body">
						...
						<div class="mb-4 mx-5">
							<div class="card h-100">
								<img src="/resources/image/icon/뒤로가기.png" class="card-img-top"
