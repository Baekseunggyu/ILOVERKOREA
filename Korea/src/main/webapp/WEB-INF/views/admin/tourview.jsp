		...
		<div id="page-content-wrapper">
			<div class="container">
				...
				<table border="1" style="margin: 0 auto; width: 50%;">
					...
					<tbody>
						<tr>
							<td style="font-size: 16px;">${item.areaName} /
								${item.cityName}</td>
						</tr>
						<tr>
				...
				<div style="margin-top: 20px; padding-left: 31%;">
					<button type="button"
						onclick='location.href = "/admin/tourupdate/${item.tourId}"'
						class="btn btn-primary btn-sm" style="">수정</button>
					<button type="button"
						onclick='location.href = "/admin/tourdelete/${item.tourId}"'
						class="btn btn-danger btn-sm" style="">삭제</button>
