			...
			<div class="containe mt-5">
				<div class="row">
					<div class="col-md-8 mx-auto">
						...
						<form class="row">
							...
							<div class="col-3 ms-1">
								<input type="text" name="keyword"
									...
									placeholder="검색어를 입력해주세요" style="float: right;">
							</div>
							<div class="col-7 mb-1" style="margin-left: -1%">
								<input type="submit" value="검색"
									class="btn btn-primary btn-sm mb-1" style="float: right;">
							</div>
							...
							<div class="container">
								<div style="margin: auto;">
									<c:forEach var="item" items="${list}">
										<div class="card">
											<img src="/upload/files/${item.tourImages[0].filename}"
												class="card-img-top img-fluid"
												onclick="location.href='./tourview/${item.tourId}'">
											<div class="card-body">
						...
						<a type="button" class="btn btn-primary mx-1" href="./"
							style="float: right;">이전</a>

						<c:if test="${sessionScope.member.id == 'admin'}">
							<a type="button" class="btn btn-secondary" href="/admin/touradd"
