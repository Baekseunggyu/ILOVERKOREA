					...
					<div class="col-lg-5 grid-margin stretch-card">
						<div class="card">
							<div class="card-body">
								...
								<form name="form" method="post" action="noticeadd"
									class="forms-sample">
									<div class="form-group">
										<label>제목:</label> <input name="nSubject" id="nSubject"
									...
									<div class="form-group">
										<label>작성자:</label> <input type="text" name="nWriter"
											id="nWriter" class="form-control"
											value="${sessionScope.member.id}" readonly>
									</div>
									<div>
										<button id="save" type="submit"
											class="btn btn-outline-primary btn-icon-text">
											<i class="fa fa-check btn-icon-prepend">등록</i>
										</button>
										...
										<button type="button"
											onclick="location.href = '${path}/admin/noticelist';"
