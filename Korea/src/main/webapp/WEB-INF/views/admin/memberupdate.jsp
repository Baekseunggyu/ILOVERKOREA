					...
					<div class="col-md-8 mx-auto">
						...
						<form method="post">
							<div class="form-group">
								<label>아이디:</label> <input type="text" value="${item.id}"
							...
							<div class="form-group">
								<label>비밀번호:</label> <input type="password" name="passwd"
									value="${item.passwd}" class="form-control">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>전화번호:</label> <input type="text" name="tel"
									value="${item.tel}" class="form-control">
							</div>
							<div class="form-group">
							...
							<div>
								...
								<button class="btn btn-outline-primary"
									style="float: right; margin-top: 15px;">변경</button>
							</div>
						</form>
					</div>
				</div>
