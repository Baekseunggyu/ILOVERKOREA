				...
				<div class="row">
					<div class="col-md-8 mx-auto">
							...
							<tbody>
								...
								<c:forEach var="item" items="${list}">
									<tr>
										...
										<td>${item.areaMapx}</td>
										<td>${item.areaMapy}</td>
										<td><a href="delete?areaId=${item.areaId}">삭제</a> <a
											href="update?areaId=${item.areaId}">변경</a></td>
									</tr>
						...
						<div style="float: right">
							<a type="button" class="btn btn-secondary" href="add">등록</a> <a
								type="button" href="/admin/" class="btn btn-primary">이전</a>
						</div>
					</div>
				</div>
			</div>
