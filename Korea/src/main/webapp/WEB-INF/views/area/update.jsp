							...
							<div class="card">
								<div class="card-body">
									...
									<form method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
											<label>지역명:</label> <input type="text" name="areaName"
												value="${item.areaName}" class="form-control">
										</div>
										<div class="form-group">
											<label>위도:</label> <input type="text" name="areaMapx"
												value="${item.areaMapx}" class="form-control">
										</div>
										<div class="form-group">
											<label>경도:</label> <input type="text" name="areaMapy"
												value="${item.areaMapy}" class="form-control">
										</div>

										<div style="padding-left: 49%;">
											<button id="save" type="submit"
												class="btn btn-outline-primary btn-icon-text">
												<i class="fa fa-check btn-icon-prepend"></i>변경
											</button>
