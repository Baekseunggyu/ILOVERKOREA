			...
			<form name="signupForm" method="post">
				<div class="fadeIn first">
					...
					<div class="id">
						<input type="text" name="id" onchange="changeId()"
							placeholder="아이디를 입력하세요" required> <a
							style="font-size: small;" onclick="checkId_Async()">중복확인</a>
					</div>
				</div>
				...
				<div class="btn-group mt-1">
					<button type="button" id="sign"
						class="btn btn-outline-primary bi bi-person-plus-fill "
						style="margin-right: 30px; border-radius: 5px" onclick="signup()">회원가입</button>

					<button type="button" id="cancil"
						class="btn btn-outline-danger bi bi-x-octagon-fill "
						style="border-radius: 5px" onclick="goBack()">취소</button>
				</div>
			</form>
		</div>
	</div>
